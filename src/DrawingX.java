 ...
 *It is used to store the details pertaining to an X-shaped object for the drawing program.
 */
...
public class DrawingX  extends DrawingObject {
	 ...
	 *The X is defined by its two opposite corners, (x1, y1) and (x2, y2).
	 */
	 ...
	 * The two corners, (x1, y1) and (x2, y2), that define the X are updated.
	 */
	//---------------
	//methods
	//---------------
	 ...
	 * where the user has clicked, hits any part of this X.
	 */
	 ...
	 * A bounding box is the smallest rectangle that contains the X.
	 */
