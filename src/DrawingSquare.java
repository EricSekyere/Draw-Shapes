...
public class DrawingSquare extends DrawingObject {
	...
	/**
	 * This constructs a new DrawingSquare object. The square is defined by its
	 * two corners, (x1, y1) and (x2, y2).
	 * 
	 * @param x1
	 *            x coordinate of the first end(corner) point of the square
	 *            object
	 * @param y1
	 *            y coordinate of the first end(corner) point of the square
	 *            object
	 * @param x2
	 *            x coordinate of the second end(corner) point of the square
	 *            object
	 * @param y2
	 *            y coordinate of the second end(corner) point of the square
	 *            object
	 */
	...
	/**
	 * This resizes a DrawingSquare object. The two corners, (x1, y1) and (x2,
	 * y2), that define the square are updated.
	 */
	// ------------
	// methods
	// ------------
	 ...
	 * has clicked, hits the edge of this square.
	 */
	...
	public boolean wasClicked(int px, int py) {
		return clickHitLine(px, py, x1, y1, x1 + width, y1)
				...
				|| clickHitLine(px, py, x1, y1 + height, x1 + width, y1
						+ height)
	 ...
	 * rectangle that contains the square.
	 */
