 ...
 *
 * The four abstract functions defined in this class must be implemented in
...
public abstract class DrawingObject
{
   ...
   /*****************************************************
    *
    *  These are the four abstract functions that the
    *  subclasses that extend this class must implement
    *
    *****************************************************/
    ...
    * the 'bounding box'.  The bounding box is the smallest
    * rectange that contains the object.
    */
   ...
   /*****************************************************
    *
    *  The following code is all about checking whether
    *  a point or line has been clicked
    *
    *****************************************************/
   ...
   public static boolean clickHitEllipse(int px, int py, int x1, int y1, int x2, int y2)
   {
      ...
      Ellipse2D.Float innerEllipse = new Ellipse2D.Float(
            minX + SELECTION_DISTANCE, minY + SELECTION_DISTANCE,
            maxX-minX - 2*SELECTION_DISTANCE, maxY-minY - 2*SELECTION_DISTANCE);

      Ellipse2D.Float outerEllipse = new Ellipse2D.Float(
            minX - SELECTION_DISTANCE, minY - SELECTION_DISTANCE,
            maxX-minX + 2*SELECTION_DISTANCE, maxY-minY + 2*SELECTION_DISTANCE);
