 ...
 *It is used to store the details pertaining to an ellipse for the drawing program.
 */
...
public class DrawingEllipse extends DrawingObject {
	 ...
	 * The ellipse is defined by its bounding box coordinates, (x1, y1) and (x2, y2).
	 */
	 ...
	 * The two bounding box coordinates, (x1, y1) and (x2, y2), that define the ellipse are updated.
	 */
	//--------------
	//methods
	//--------------
	 ...
	 * where the user has clicked, hits the edge of this ellipse.
	 */
	 ...
	 * A bounding box is the smallest rectangle that contains the ellipse.
	 */
